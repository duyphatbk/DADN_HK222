...
class MQTTService {
    ...
    constructor() {
        ...
        this.username = 'hienhien612'
        this.password = 'aio_xmUQ32ASYkQTt1MbA1NRsOkNKbBB'
    ...
    connect = (handleSuccess) => {
        if (!this.isConnected) {
            this.client.connect({
                ...
                password: 'aio_xmUQ32ASYkQTt1MbA1NRsOkNKbBB',
                onSuccess: async () => {
    ...
    publishMessage = (topic) => {
        this.client.publish(`${topic}/get`, 'hienhien612');
    };
